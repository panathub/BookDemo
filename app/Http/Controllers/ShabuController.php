...
class ShabuController extends Controller
{
  ...
  public function index(){
    ...
    public function getBookingShabu(Request $request){
    ...
    public function getBookingShabu2TEST(Request $request){
        //$booking_id = $request->booking_id;
       // $RoomID = $request->room_id;
        $today = date('Y-m-d H:i');
        ...
        WHERE rooms.RoomID = '66' And bookings.VerifyStatus = '1'
        ...
        INNER JOIN rooms ON rooms.RoomID = bookings.RoomID 
        LEFT JOIN department ON department.DepartmentID = users.DepartmentID 
        WHERE rooms.RoomID = '66' And bookings.BookingID != $homeBookings And bookings.VerifyStatus = '1'
        ORDER BY Booking_start ASC";
    ...
    public function deleteBookingShabu(Request $request){
