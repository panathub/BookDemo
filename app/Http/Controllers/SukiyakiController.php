...
class SukiyakiController extends Controller
{
  ...
  public function index(){
    ...
    public function getBookingSukiyaki(Request $request){
    ...
    public function getBookingSukiyaki2TEST(Request $request){
        //$booking_id = $request->booking_id;
       // $RoomID = $request->room_id;
        $today = date('Y-m-d H:i');
    ...
    public function deleteBookingSukiyaki(Request $request){
