...
<!---------------------------------------------------------- USER ---------------------------------------------------------------->
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <!--Modal Info -->
    <div class="modal fade infoUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
$('#addDepartment').on('submit', function(e){
      ...
      $(document).on('click','#editDBtn', function(){
         ...
         $.post('<?= route("get.department.details") ?>',{d_id:d_id}, function(data){
...
$('#addUser').on('submit', function(e){
      ...
      $(document).on('click','#editUserBtn', function(){
         ...
         $.post('<?= route("get.user.details") ?>',{user_id:user_id}, function(data){
              ...
              $('.editUser').find('input[name="password"]').val(data.details.password);  
