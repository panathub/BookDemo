...
<div class="loader-wrapper">
  ...
  <header style="background-image: linear-gradient(45deg, #FA8BFF 0%, #2BD2FF 52%, #2BFF88 90%);">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav text-center">
            ...
            <li class="nav-item dropdown">
              <div class="dropdown">
                <a href="/" class="nav-link">ห้องประชุม</a>
                <span class="sr-only">(current)</span>
 ...
 $.ajaxSetup({
      ...
      $(document).ready(function(){
        ...
        //console.log(display_c5());
             ...
             //* -----------------------------------------------------------------------------
             $.get('<?= route("get.booking.shabu") ?>',{booking_id:booking_id}, function(data){
          ...
          var time = today.getHours() + ":" + today.getMinutes()
             //* -----------------------------------------------------------------------------
             $.get('<?= route("get.booking.shabu.test") ?>',{booking_id:booking_id}, function(data){
                //alert(room_id);  
              $('input[name="bkid"]').val(data.details.BookingID);
              $('input[name="rid"]').val(data.details.RoomID);
              $('.name').text(data.details.name);  
          ...
          var booking_id = $(this).data('id');
             //* -----------------------------------------------------------------------------
             $.post('<?= route("delete.booking.shabu") ?>',{booking_id:booking_id}, function(data){             
          },'json');
        }
