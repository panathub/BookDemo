      ...
      $(document).ready(function(){
       ...
       // let timeAfter30Mins = new Date();
        ...
        //console.log(display_c5());
             ...
             //* -----------------------------------------------------------------------------
             $.get('<?= route("get.booking.kinoko") ?>',{booking_id:booking_id}, function(data){
          ...
          var time = today.getHours() + ":" + today.getMinutes()
             //* -----------------------------------------------------------------------------
             $.get('<?= route("get.booking.kinoko.test") ?>',{booking_id:booking_id}, function(data){
                //alert(room_id);  
              $('input[name="bkid"]').val(data.details.BookingID);
              $('input[name="rid"]').val(data.details.RoomID);
              $('.name').text(data.details.name);  
          ...
          var booking_id = $(this).data('id');
             //* -----------------------------------------------------------------------------
             $.post('<?= route("delete.booking.kinoko") ?>',{booking_id:booking_id}, function(data){             
          },'json');
        }
